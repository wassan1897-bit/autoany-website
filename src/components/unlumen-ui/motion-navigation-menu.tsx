    ...
    frameRef.current = requestAnimationFrame(() => {
      ...
      if (contentWidth > 0) {
        ...
        while (ancestor && ancestor !== document.body) {
          ...
          const overflow = css.overflow + css.overflowX;
...
const motionNavigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium text-hero-fg hover:text-hero-fg focus:text-hero-fg disabled:pointer-events-none disabled:opacity-50 data-[state=open]:text-hero-fg focus-visible:ring-ring/50 outline-none transition-colors focus-visible:ring-[3px] focus-visible:outline-1 cursor-pointer",
);
  ...
  return (
    <HighlightItem asChild>
      ...
      >
        ...
        >
          <ChevronDownIcon className="size-3.5 stroke-2" aria-hidden="true" />
        </motion.span>
      </button>
    </HighlightItem>
  );
